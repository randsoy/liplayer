...
/// LiSlider is like Slider in Flutter SDK.
/// LiSlider support [cacheValue] which can be used
/// to show the player's cached buffer.
/// The [colors] is used to make colorful painter to draw the line and circle.
class LiSlider extends StatefulWidget {
  final double value;
  ...
  State<StatefulWidget> createState() {
    return _LiSliderState();
  }
}

class _LiSliderState extends State<LiSlider> {
  bool dragging = false;
...
class LiSliderColors {
  const LiSliderColors({
