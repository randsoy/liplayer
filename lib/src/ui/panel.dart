...
class _DefaultLiPanel extends StatefulWidget {
  final LiPlayer player;
  final BuildContext buildContext;
  final Size viewSize;
  final Rect texturePos;

  const _DefaultLiPanel({
  ...
  @override
  _DefaultLiPanelState createState() => _DefaultLiPanelState();
}
...
class _DefaultLiPanelState extends State<_DefaultLiPanel> {
  ...
  void initState() {
    ...
    _prepared = player.state.index >= LiState.prepared.index;
    _playing = player.state == LiState.started;
                  ...
                  child: Container(
                    ...
                    child: Center(
                        child: _exception != null
                            ...
                            : (_prepared || player.state == LiState.initialized)
                                ? AnimatedOpacity(
