...
import com.example.liplayer.core.LiEngine;
import com.example.liplayer.core.LiPlayer;
import com.example.liplayer.core.LiVolume;
import com.example.liplayer.core.QueuingEventSink;
 ...
 * LiPlugin
 */
public class LiplayerPlugin implements MethodCallHandler, FlutterPlugin, ActivityAware, LiEngine, LiVolume.VolumeKeyListener, AudioManager.OnAudioFocusChangeListener {
    ...
    final private SparseArray<LiPlayer> LiPlayers = new SparseArray<>();
    ...
    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "example.com/liplayer");
        LiplayerPlugin plugin = new LiplayerPlugin();
        plugin.initWithRegistrar(registrar);
        channel.setMethodCallHandler(plugin);

        final LiPlayer player = new LiPlayer(plugin, true);
        player.setupSurface();
        player.release();
    }
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
        final MethodChannel channel = new MethodChannel(binding.getBinaryMessenger(), "example.com/liplayer");
        initWithBinding(binding);
        channel.setMethodCallHandler(this);

        final LiPlayer player = new LiPlayer(this, true);
        player.setupSurface();
        player.release();
    ...
    public void onAttachedToActivity(ActivityPluginBinding binding) {
        ...
        if (mActivity.get() instanceof LiVolume.CanListenVolumeKey) {
            LiVolume.CanListenVolumeKey canListenVolumeKey = (LiVolume.CanListenVolumeKey) mActivity.get();
    ...
    private void init(BinaryMessenger messenger) {
        ...
        mEventChannel = new EventChannel(messenger, "befovy.com/Li/event");
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        ...
        switch (call.method) {
            ...
            case "init":
                ...
                break;
            case "createPlayer": {
                LiPlayer LiPlayer = new LiPlayer(this, false);
                int playerId = LiPlayer.getPlayerId();
                LiPlayers.append(playerId, LiPlayer);
            ...
            case "releasePlayer": {
                ...
                if (arg != null)
                    pid = arg;
                LiPlayer LiPlayer = LiPlayers.get(pid);
                if (LiPlayer != null) {
                    LiPlayer.release();
                    LiPlayers.delete(pid);
                }
                result.success(null);
                break;
            }
    ...
    public void onAudioFocusChange(int focusChange) {
        ...
        Log.i("LiPLAYER", "onAudioFocusChange: " + focusChange);
    }
    ...
    public void audioFocus(boolean request) {
        Log.i("LiPLAYER", "audioFocus " + (request ? "request" : "release") + " state:" + mAudioFocusRequested);
    ...
    private AudioManager audioManager() {
        ...
        if (context != null) {
            ...
            Log.e("LiPLAYER", "context null, can't get AudioManager");
            return null;
        }
    }
