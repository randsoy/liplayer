...
const List<MediaUrl> samples = [
  ...
  MediaUrl(title: "http 404", url: "https://Liplayer.befovy.com/butterfly.flv"),
...
class SamplesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const LiAppBar.defaultSetting(title: "Online Samples"),
...
class RecentMediaList extends StatefulWidget {
  ...
  @override
  createState() => _RecentMediaListState();
}
